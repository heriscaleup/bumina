...
export const metadata: Metadata = generateMetadataObject({
  ...
  description: 'Cari villa atau penginapan dekat Situ Cileunca Pangalengan? Homestay Bumina EENK sekitar 26 menit, maksimal 20 orang, dengan perapian dan dapur lengkap.',
  keywords: ['villa dekat situ cileunca', 'penginapan dekat situ cileunca', 'villa situ cileunca pangalengan', 'homestay situ cileunca', 'villa pangalengan 20 orang', 'penginapan pangalengan terpercaya'],
...
const jsonLd = {
  ...
  description: 'Villa privat sekitar 26 menit dari Situ Cileunca Pangalengan. Maksimal 20 orang, perapian hangat, dapur lengkap, dan suasana kebun teh.',
  url: SITE_URL,
...
const faqs = [
  { q: 'Berapa jauh Bumina EENK dari Situ Cileunca?', a: 'Homestay Bumina EENK berjarak sekitar 26 menit berkendara dari Situ Cileunca dan nyaman dijadikan basecamp wisata Pangalengan.' },
  { q: 'Berapa kapasitas Homestay Bumina EENK?', a: 'Kapasitas maksimal 20 orang — cocok untuk keluarga besar, rombongan kantor, gathering, arisan, atau reuni.' },
  ...
  { q: 'Berapa harga menginap di Bumina EENK?', a: 'Weekday Rp850.000 dan weekend Rp900.000 per malam untuk 5 orang. Tamu tambahan Rp70.000 per orang, dengan kapasitas maksimal 20 orang.' },
    ...
    <div className="font-sans antialiased">
      ...
      <section className="relative min-h-[78vh] flex items-center justify-center overflow-hidden bg-emerald-950">
        <div className="absolute inset-0">
          <Image src="/images/editorial/homestay-rain.webp" alt="Homestay hangat di tengah kabut Pangalengan" fill priority unoptimized sizes="100vw" className="object-cover scale-[1.03]" />
          <div className="absolute inset-0 bg-gradient-to-b from-emerald-950/30 via-slate-950/55 to-emerald-950/95" />
        </div>
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center pt-24 pb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-4">
            Sekitar <strong className="text-emerald-400">26 menit berkendara</strong> dari Situ Cileunca. Maksimal 20 orang. Terdaftar Agoda & Booking.com rating <strong className="text-yellow-400">4.9★</strong>.
          </p>
          <div className="flex flex-wrap justify-center gap-3 mb-10">
            {['✅ Agoda Verified', '✅ Booking.com 4.9★', '🔥 Perapian Hangat', '👥 Maksimal 20 Orang'].map(b => (
      ...
      <section className="bg-white py-8 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
            {[
              { icon: '📍', label: 'Jarak ke Situ Cileunca', val: '±26 menit' },
              { icon: '👥', label: 'Kapasitas', val: 'Maks. 20 orang' },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-12">
            {[
              { icon: '📍', title: '±26 Menit dari Situ Cileunca', desc: 'Home base privat untuk menikmati kawasan danau tanpa kehilangan suasana kebun teh.' },
              { icon: '👥', title: 'Maksimal 20 Orang', desc: 'Sewa keseluruhan rumah untuk grup — lebih privat dan lebih leluasa.' },
          ...
          <div className="bg-emerald-900 rounded-3xl p-8 text-white">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                { dest: 'Situ Cileunca', dist: '±26 mnt' },
                { dest: 'Hutan Pinus Rahong', dist: '±32 mnt' },
                { dest: 'Nimo Highland', dist: '±45 mnt' },
